...
import { OpenAIRealtimeEmitter, buildRealtimeURL, isAzure } from "./internal-base.js";
export class OpenAIRealtimeWebSocket extends OpenAIRealtimeEmitter {
  url;
  socket;
  constructor(props, client){
    super();
    const dangerouslyAllowBrowser = props.dangerouslyAllowBrowser ?? client?._options?.dangerouslyAllowBrowser ?? (client?.apiKey.startsWith('ek_') ? true : null);
